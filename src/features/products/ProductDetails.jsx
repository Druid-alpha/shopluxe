      ...
      <div className="md:w-1/2 space-y-4">
        ...
        <div className="space-y-2 text-sm bg-gray-50 p-5 rounded-lg border mt-6">
          ...
          <div className="mt-4 pt-4 border-t flex items-center justify-between">
            ...
            {currentStock > 0 ? (
              <span className="text-green-600 font-bold bg-green-50 px-4 py-1.5 rounded-full border">
                {currentStock} UNITS AVAILABLE
              </span>
            ) : (
              <span className="text-red-500 font-bold bg-red-50 px-4 py-1.5 rounded-full border">
                OUT OF STOCK
              </span>
            )}
          </div>
