        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 mt-8">
          ...
          <div>
            ...
            <Input
              ...
              className={`appearance-none block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-black focus:border-black sm:text-sm ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'}`}
            />
